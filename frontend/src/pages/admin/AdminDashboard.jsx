...
export default function AdminDashboard() {
  ...
  return (
    <Layout title="Dashboard Overview" subtitle={`Overview · ${productivityData?.week_label || ''}`}>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-6 bg-white border border-border p-4 rounded-xl shadow-sm">
        <div className="flex items-center gap-2">
          <span className="text-sm font-semibold text-charcoal">Weekly Productivity View</span>
          {fetching && (
      ...
      {/* ── Weekly Productivity Sheet Card ── */}
      <div className="card p-0 overflow-hidden border border-border shadow-md mb-6">
